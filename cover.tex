...
%%% Edit author's name
%% Author's full name
\Author{Marta Pereira\\Neves}

%%% Edit thesis title in Portuguese
%% Thesis Mandatory Title in Portuguese
\TitlePT{Descrição da dor através de aprendizagem não supervisionada}
...
\TitleEN{Unsupervised learning for pain description}
...
\Supervisora{Susana Brás}{Auxiliar}
...
\Degree{Licenciatura}{Engenharia Biomédica}
...
\JuriMember{Doutora Ana Luísa Monteiro da Silva}{Professora Auxiliar da Universidade de Aveiro}

%%% Repeat the above declaration for additional
%%%  members of the jury as many times as necessary.
%% Additional members of the Jury
\JuriMember{Doutora Ana Raquel Ferreira de Almeida Sebastião}{Investigadora do Instituto de Engenharia Eletrónica e Informática de Aveiro (IEETA) (Arguente)}
\JuriMember{Doutora Susana Manuela Martinho dos Santos Baía Brás}{Professora Auxiliar do Departamento de Eletrónica, Telecomunicações e Informática da Universidade de Aveiro, e investigadora do Instituto de Engenharia Eletrónica e Informática de Aveiro (IEETA) (Orientadora)}
